...
<template>
  <div class="fixed top-0 left-0 z-40 w-full flex lg:hidden items-center justify-between px-12 py-6 bg-skywhite/[.4] backdrop-blur-md">
    ...
    <div :class="menuOpen ? 'overflow-hidden fixed top-0 right-0 w-[30vw] h-[100vh] bg-angry text-white text-center z-40 transition-all duration-[700ms]' : 'overflow-hidden fixed top-0 right-0 w-[30vw] h-0 bg-angry text-white text-center z-40 transition-all duration-300'">
